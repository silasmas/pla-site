                        ...
                        <a href="{{ route('detailBureau', ['id'=>$b->id,'p'=>$b->id]) }}">
                            <div class="card">
                                <div class="text-star">
                                    ...
                                    <h4>{!! strlen(strip_tags($b->adresse))>13?substr(strip_tags($b->adresse),0,13)."...":$b->adresse!!}</h4>
                                    <p>{{ $b->titre}}</p>
                                    <p>Email : {{ $b->email }}</p>
                                    <p>Tel : {{ $b->telephone }}</p>
                                </div>
            ...
            <div class="container">
                <div class="row g-3 g-sm-5 g-lg-0">
                    <div class="col-lg-6 col-sm-6">
                        <div class="card">
                            <img src="{{ !empty($about->photohome)?asset('storage/'.$about->photohome):asset('img/default.png') }}" alt="img">
                    ...
                    <div class="col-lg-6 col-sm-6 col-bar">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <p>{!! !empty($about->extrait)?Str::limit($about->extrait,700, '...'):'Vide '!!}</p>
                            </div>
                            <div class="col-sm-12">
