...
<div class="about about-sm">
    <div class="container">
        <div class="row g-3 g-sm-5 g-lg-5">
            <div class="col-lg-6 col-sm-6 ">
                ...
                {{-- <p>
                    @if (Str::length(strip_tags($about->contenu))>1000)
                    {!! Str::substr($about->contenu,0, 1800).'...' !!}
                    @else
                    {!! $about->contenu !!}
                    @endif
    ...
    {{--  MODAL READ MORE  --}}
    <div class="modal fade" id="modal-read-more" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
