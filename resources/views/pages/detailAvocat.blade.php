                        ...
                        <div class="block-about">
                            <div class="row">
                                ...
                                {{-- <div class="col-lg-3 col-md-4">
                                    <a href="#" id="{{ $avocat->pdfbio}}" class="btn btn-download"><i class="fas fa-download"></i> Télécharger CV</a>
                                </div> --}}
                            </div>
                                @empty(!$bureau->bureau)
                                    @foreach ($avocat->bureau as $item)
                                        <h6 class="mb-3 bureau"><i class="fas fa-map-marker"></i>
                                        <a href="{{ route('detailBureau', ['id'=>$item->id,'p'=>$item->id]) }}" id='btnverBureau'>
